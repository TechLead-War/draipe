...
from ssl import (CERT_NONE, CERT_REQUIRED, CHANNEL_BINDING_TYPES,
                 SSL_ERROR_EOF, SSL_ERROR_WANT_READ, SSL_ERROR_WANT_WRITE,
                 DER_cert_to_PEM_cert, PROTOCOL_SSLv23, SSLEOFError, SSLError,
                 SSLObject, SSLWantReadError, SSLWantWriteError,
