...
import _socket
from _socket import (AF_INET, AF_UNSPEC, AI_CANONNAME, AI_NUMERICHOST,
                     AI_PASSIVE, EAI_NONAME, EAI_SERVICE, SOCK_DGRAM,
                     SOCK_STREAM, SOL_TCP, error, gaierror)
...
from gevent._compat import (MAC, PY3, PYPY, hostname_types, integer_types,
