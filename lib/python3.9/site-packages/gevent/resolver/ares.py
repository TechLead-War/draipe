...
from gevent._compat import PY3, integer_types, text_type
from gevent._config import AresSettingMixin, config
from gevent.hub import Waiter, get_hub
from gevent.socket import (AF_INET, AF_INET6, AF_UNSPEC, SOCK_DGRAM,
                           SOCK_STREAM, SOL_TCP, SOL_UDP)

from . import AbstractResolver
from . import _lookup_port as lookup_port
from .cares import (InvalidIP,  # pylint:disable=import-error,no-name-in-module
                    channel)
